...
class FaceCompare():
    ...
    def stream_handler(message):
            ...
            print(StudentID)
            StudentID=""
    my_stream = db.child("Student/ID").stream(stream_handler)
    ...
    def video_feed(request):
        return StreamingHttpResponse(FaceCompare.detect(), content_type='multipart/x-mixed-replace; boundary=frame')